...
const navigationMenuTriggerStyle = cva(
  "group inline-flex h-10 w-max items-center justify-center rounded-md bg-white text-teal-500 px-4 py-2 text-md font-medium transition-colors hover:bg-teal-200 hover:text-slate-800 focus:bg-slate-100 focus:text-slate-800 focus:outline-none disabled:pointer-events-none disabled:opacity-50 data-[active]:bg-teal-200 data-[active]:text-slate-800 data-[state=open]:bg-slate-100/50 dark:bg-slate-950 dark:hover:bg-slate-800 dark:hover:text-slate-50 dark:focus:bg-slate-800 dark:focus:text-slate-50 dark:data-[active]:bg-slate-800/50 dark:data-[state=open]:bg-slate-800/50"
)
