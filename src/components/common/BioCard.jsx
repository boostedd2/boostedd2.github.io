      ...
      <Card className="xs:w-[100%] sm:px-0 md:px-5 sm:py-0 md:py-10">
        ...
        <CardContent>
          <p className="leading-relaxed">
            ...
            professional experience building custom web applications, and also years of previous experience working in
          ...
          <p className="leading-relaxed mt-4">
            ...
            writing software or reading books about software architecture and design. Most of all, I am dedicated to learning as much as I
